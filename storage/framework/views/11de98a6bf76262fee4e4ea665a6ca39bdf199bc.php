                              ...
                              <div class="sc-pro-list" id="tpshop-cart">
                                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                    ...
                                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      ...
                                      <tr class="item-single" id="edge_<?php echo e($value->id); ?>">
                                            <td class="pa-le-9" style="border-right:0" align="center" valign="middle">
                                                <input class="check-box checkCart checkCartItem" name="checkItem" value="<?php echo e($value->id); ?>" type="checkbox" <?php if($value->select==1): ?> checked='checked' <?php endif; ?>>
                                            </td>
                                            <td style="border-left:0px;;border-right:0px" class="pa-to-20 pa-bo-20 bo-ri-0" width="80px" align="center" valign="top">
                                                <a class="gwc-wp-list di-bl wi63 hi63" href="/item/<?php echo e($value->goods_id); ?>">
                                                    <img class="wi63 hi63" src="<?php echo e($picture[0]); ?>">
                                                </a>
                                            </td>
                                            <td style="border-left:0px; border-right:0px" class="pa-to-20 wi516" align="left">
                                                <p class="gwc-ys-pp">
                                                    <a href="/item/<?php echo e($value->goods_id); ?>" style="vertical-align:middle"><?php echo e($value->goods_name); ?></a>
                                                </p>
                                                <p class="ggwc-ys-hs"><?php echo e($value->spec_key_name); ?></p>
                                            </td>
                                            <td style="border-left:0px" align="center" valign="middle"><span>￥<?php echo e($value->market_Price); ?></span></td>
                                            <td style="border-left:0px" align="center" valign="middle" id="cart_<?php echo e($value->id); ?>_goods_price"><?php echo e($value->goods_price); ?></td>
                                            <td align="center" valign="middle" class="quantity-form">
                                                <div class="sc-stock-area">
                                                    <div class="stock-area">
                                                        <a class="decrement" onclick="" title="减">-</a>
                                                            <input class="wi43 fl" name="changeQuantity_<?php echo e($value->id); ?>" type="text" id="changeQuantity_<?php echo e($value->id); ?>" value="<?php echo e($value->goods_num); ?>">
                                                        <a class="increment" onclick="" title="加">+</a>
                                                    </div>
                                                    <em class="red" style="display: none">库存不足</em>
                                                </div>
                                            </td>
                                            <td align="center" valign="middle" id="cart_<?php echo e($value->id); ?>_market_price"><?php echo e(($value->goods_num)*($value->goods_price)); ?></td>
                                            <td align="center" valign="middle"><a class=" deleteGoods" data-cart-id="<?php echo e($value->id); ?>" href="javascript:void(0);">X</a></td>
                                        </tr>
