...
<div class="page">
    ...
    <!--表单数据-->
    <form method="post" id="addEditGoodsForm" action="/store/my/goods/<?php echo e($goods->id); ?>/edit">
<!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea rows="3" cols="80" name="goods_remark" class="input-txt"><?php echo e($goods->goods_title2); ?></textarea>
