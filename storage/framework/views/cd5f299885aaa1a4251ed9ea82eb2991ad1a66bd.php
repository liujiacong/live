...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    <tr>
      <th width="5%">ID</th>
      <th width="15%">商城分类名</th>
      <th width="10%">是否展示</th>
      <th width="10%">是否热门</th>
      <th width="10%">排序</th>
      <th width="10%">操作</th>
    </tr>
    <?php $__currentLoopData = $GoodsCate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td><div class="button-group"><a class="button border-main" href="/store/my/<?php echo e($value->id); ?>/cate_edi"><span class="icon-edit"></span> 修改</a>
...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/store/my/cate_add">
