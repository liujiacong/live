<?php echo $__env->make('layout.storehead', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		<div class="wrapper">
			...
			<div class="container mt-70">
				<div class="row">
					<div class="col-lg-1">
						<span class="dis-inlineblock drow-8"><?php if($cate_id==0): ?>所有商品<?php endif; ?>共<?php echo e($goods->total()); ?>个</span>
					</div>
					<div class="col-lg-2">
											...
											<div class="row">
												<div class="col-lg-12 pb-20 pl-20 pr-20">
													...
													<div class='col-lg-4 text-left'>
														...
														<span class="info">￥<?php echo e($value->shop_price); ?></span>
