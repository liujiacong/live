    ...
    <div class="search-box p">
        <div class="w1224">
            <div class="search-path fl">
                    ...
                    <i class="litt-xyb"></i>
                                <div class="havedox">
                    <span><?php echo e($Goods->goods_title); ?></span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                          <?php   $picture=unserialize($Goods->picture);   ?>
                            ...
                            <img id="zoomimg" src="<?php echo e($picture[0]); ?>" jqimg="<?php echo e($picture[0]); ?>" alt="">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                                ...
                                <ul class="small-pic" style="left:0;">
                                  <?php        foreach ($picture as $key => $value) { ?>
                                    ...
                                    <li class="small-pic-li">
                                        <a href="javascript:;">
                                            <img src="<?php echo e($value); ?>" data-img="<?php echo e($value); ?>" data-big="<?php echo e($value); ?>">
                                            <i></i>
                                        </a>
                                    </li>
                                <?php  } ?>
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" action='/shopping'>
             <?php echo e(csrf_field()); ?>
              ...
              <input type="hidden" id="item_id" name="item_id" value=""/><!-- 商品规格id -->
                ...
                <h1><?php echo e($Goods->goods_title); ?> <span style="color:red;"><?php echo e($Goods->goods_title2); ?></span></h1>
                <!--商品抢购 start-->
                                <!--商品抢购  end-->
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><span>￥</span><span><?php echo e($Goods->shop_price); ?></span></span>
                            </li>
                        </ul>
                        <ul>
                            <li class="jaj"><span>市场价：</span></li>
                            <li class="though-line"><span><em>￥</em><?php echo e($Goods->market_Price); ?></span></li>
                        </ul>
                                            </div>
                    <div class="shop-cou-ri">
                        <div class="allcomm"><p>累计评价</p><p class="f_blue"><?php echo e($Goods->comment_count); ?></p></div>
                        <div class="br1"></div>
                        <div class="allcomm"><p>累计销量</p><p class="f_blue"><?php echo e($Goods->sale_count); ?></p></div>
                    </div>
                </div>
                    ...
                    <?php foreach($filter_spec as $key=>$value) {  ?>
                          <div class="standard p">
                                <ul>
                                    <li class="jaj"><span><?php echo e($key); ?>：</span></li>
                                    <li class="lawir colo">
                                    <?php foreach($value as $k=>$v) {  ?>
                                    <?php if($k==0): ?>
                                    <input type="radio" style="display: none" rel="<?php echo e($v['item']); ?>" name="goods_spec[<?php echo e($key); ?>]" value="<?php echo e($v['item_id']); ?>"checked="checked" >
                                    <a onclick="select_filter(this);" class="red"><?php echo e($v['item']); ?></a>
                                    <?php else: ?>
                                    <input type="radio" style="display: none" rel="<?php echo e($v['item']); ?>" name="goods_spec[<?php echo e($key); ?>]" value="<?php echo e($v['item_id']); ?>">
                                    <a onclick="select_filter(this);" class=""><?php echo e($v['item']); ?></a>
                                    <?php endif; ?>
                                    <?php } ?>
                  ...
                  <?php } ?>
                            ...
                            <div class="standard p">
                              ...
                              <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCarts(<?php echo e($Goods->id); ?>,1,0);">立即购买</a>
                             <!--  <a id=""  class="addcar" href="javascript:;" onclick="AjaxAddCarts(<?php echo e($Goods->id); ?>,1,0);"><i class="sk"></i>加入收藏</a> -->
                ...
                <div class="introduceshop">
                    ...
                    <div class="shop-describe shop-con-describe p" style="display: block;">
                        <div class="deta-descri">
                            <p class="shopname_de"><span>商品名称：</span><span><?php echo e($Goods->goods_title); ?></span></p>
                            <div class="ma-d-uli p">
                                <ul>
                                  <?php $__currentLoopData = $attr_; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <li><span><?php echo e($value->attr_name); ?>：</span><span><?php echo e($value->attr_value); ?></span></li>
                        ...
                        <div class="deta-descri">
                            ...
                            <?php $__currentLoopData = $attr_; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="twic_a_alon">
                                    <p class="gray_t"><?php echo e($value->attr_name); ?></p>
                                    <p><?php echo e($value->attr_value); ?></p>
                                </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                    </div>
...
<div class="operating fixed" id="bottom">
    ...
    <script type="text/javascript">
        ...
        var store_count = <?php echo e($Goods->store_count); ?>; // 商品起始库存
        //缩略图切换
        ...
        {
            var goods_price = <?php echo e($Goods->shop_price); ?>; // 商品起始价
            var store_count = <?php echo e($Goods->store_count); ?>; // 商品起始库存
            var spec_goods_price =<?php echo $spec_goods_price; ?>;
            // 优先显示抢购活动库存
                        // 如果有属性选择项
        ...
        $('#join_cart').click(function(){
          var goods_id=<?php echo e($Goods->id); ?>
 ...
 $('#pingjia').click(function(){
    $.ajax({
                ...
                type : "GET",
                url:"/ajax_comment/goods/<?php echo e($Goods->id); ?>",//+tab,
                success: function(data){
