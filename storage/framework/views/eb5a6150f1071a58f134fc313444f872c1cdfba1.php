  ...
  <div class="panel admin-panel">
          ...
          <li>
            <select name="cid" class="input" style="width:200px; line-height:17px;" onchange="window.location=this.value;">
             ...
             <?php $__currentLoopData = $cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="/admin/shop/goods/goods_cate/<?php echo e($value->id); ?>"><?php echo e($value->name); ?></option>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <tr>
          <td style="text-align:left; padding-left:20px;"><a href='/item/<?php echo e($value->id); ?>'><?php echo e($value->id); ?></a></td>
          <?php if($value->is_sale==0): ?>
          <td ><font color="#00CC99">上架</font></td>
          <?php else: ?>
          <td ><font color="red">下架</font></td>
          <?php endif; ?>
          <?php if($value->is_delect==0): ?>
          ...
          <td>
             <a class="button border-red" href="/admin/shop/goods/goods_delect/<?php echo e($value->id); ?>"><span class="icon-trash-o"></span> 删除</a>
            </div></td>
        </tr>
