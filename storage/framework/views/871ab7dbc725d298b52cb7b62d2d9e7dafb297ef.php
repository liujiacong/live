...
<?php $__currentLoopData = $Comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="people-comment">
    <div class="deta-descri p">
        <div class="person-ph-name">
            <div class="per-img-n p">
                                    <div class="img-aroun"><img src="/img/headPic.jpg"></div>
                    <div class="menb-name"><?php echo e($val->user_name); ?></div>
                            </div>
        ...
        <div class="person-com">
            ...
            <div class="lifr4 comfis p">
                <span class="faisf"><?php echo e($val->content); ?></span>
            </div>
            <!--评论时间-->
