			...
			<div class="ri-menu fr">
				    	...
				    	<div class="sc_collect book-tit shop-listanadd">
							...
							<ul>
										...
										<li class="sx1">
											<div class="shop-if-dif texle">
												<div class="shop-difimg">
													<img src="<?php echo e($picture[0]); ?>" width="100" height="100">
												</div>
												<div class="shop_name">
												<a href="/item/<?php echo e($value->id); ?>"><?php echo e($value->goods_title); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($value->goods_title2); ?></a>
												</div>
											</div>
										</li>
										<li class="sx3"><span><em>￥</em><?php echo e($value->shop_price); ?></span></li>
										<li class="sx4">
											<?php if($value->is_sale==1 ||$value->is_delect==1): ?>
                                            <span>已下架</span>
                                            <?php else: ?>
                                            <span>正常</span>
                                            <?php endif; ?>
										...
										<li class="sx5">
											<div class="adhscar">
						<a class="add_p_shop" href="/item/<?php echo e($value->id); ?>">立即查看</a>
						<a class="dele_g" href="/store/unlike/<?php echo e($value->id); ?>" href="javascript:">删除</a>
											</div>
										</li>
								</ul>
