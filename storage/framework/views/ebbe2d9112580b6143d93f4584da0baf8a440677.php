...
<head>
    <meta charset="UTF-8">
    <title>评价订单-<?php echo e($order->order_sn); ?></title>
        ...
        <div class="home-main">
                    ...
                    <div class="detail-hd" id="o-info-orderinfo" oid="20703525920" payid="4" ot="0" shipmentid="70" venderid="32+ro+cdrp0=">
                        <div class="orderinfo">
                            ...
                            <div class="o-info"> <span class="mr20">订单号：<?php echo e($order->order_sn); ?></span> <span><?php echo e($order->created_at); ?></span> </div>
                        </div>
                    </div>
                    <form method="post" id="add_comment" action='/order/comment/<?php echo e($order->id); ?>' >
                     <?php echo e(csrf_field()); ?>

                        <input type="hidden" id="order_id" name="order_id" value="<?php echo e($order->id); ?>">
                        <input type="hidden" id="goods_id" name="goods_id" value="<?php echo e($goods->id); ?>">
                                    ...
                                    <div class="f-item f-goods product-741538" voucherstatus="0" catefi="670" catese="677" cateth="680">
                                        ...
                                        <div class="fi-info">
                                            <div class="comment-goods">
                                                <div class="p-img"><a href="/item/<?php echo e($val->goods_id); ?>" target="_blank"><img src="<?php echo e($picture[0]); ?>" alt=""></a></div>
                                                <div class="p-name"><a href="/item/<?php echo e($val->goods_id); ?>" target="_blank"><?php echo e($val->goods_name); ?></a></div>
                                                <div class="p-price"><strong>￥<?php echo e($val->goods_num*$val->goods_price); ?></strong></div>
                                                <div class="p-attr"><?php echo e($val->spec_key_name); ?></div>
                                            </div>
                                        </div>
