...
<body>
  ...
  <div class="menumain p">
    ...
    <div class="order-alone-li lastset_cm">
      <?php $__currentLoopData = $order_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <table width="100%" border="" cellspacing="" cellpadding="">
        <tbody>
            ...
            <td colspan="6">
              <div class="fl_ttmm">
                <span class="time-num">下单时间：
                  <em class="num"><?php echo e($val->created_at); ?></em></span>
                <span class="time-num">订单编号：
                  <em class="num"><?php echo e($val->order_sn); ?></em></span>
                  <div class="paysoon">
                      <?php if($val->pay_status==0 && $val->order_status==0 && $val->pay_code ==""): ?>
                        <a class="ps_lj" href="/carto3/<?php echo e($val->id); ?>" target="_blank">立即支付</a>
                        <a class="consoorder" href="javascript:void(0);" onclick="cancel_order(<?php echo e($val->id); ?>)">取消订单</a>
                      <?php endif; ?>
                      <?php if($val->shipping_status==1 && $val->order_status==0): ?>
          ...
          <?php $__currentLoopData = $val->OrderGoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=>$val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($key2==0): ?>
          <tr class="conten_or">
            <td class="sx1">
              <div class="shop-if-dif">
                <div class="shop_name">
                  <a href="/item/<?php echo e($val2->goods_id); ?>"><?php echo e($val2->goods_name); ?>  &nbsp;&nbsp;&nbsp;规格:<?php echo e($val2->spec_key_name); ?></a></div>
              </div>
            </td>
            <td class="sx2">
              <span>￥</span>
              <span><?php echo e($val2->goods_price); ?></span></td>
            <td class="sx3">
              <span>x<?php echo e($val2->goods_num); ?></span></td>
            <td class="sx4" rowspan="2">
              <div class="pric_rhz">
                <p class="d_pri">
                  <span>￥</span>
                  <span class="total_price"><?php echo e($val->total_price); ?></span></p>

                <p class="d_yzo">
                  <a href="javascript:void(0);"><?php echo e($val->pay_name); ?></a></p>
              </div>
            </td>
            <td class="sx5" rowspan="2">
              <div class="detail_or">
                ...
                <p class="d_yzo">待评价</p>
                <?php elseif($val->order_status==0 && $val->pay_code!=""): ?>
                <p class="d_yzo">待发货</p>
                <?php endif; ?>
                <p>
                  <a href="/home/Order/order_detail/id/1510.html">查看详情</a>
                </p>
              </div>
            </td>
            <td class="sx6" rowspan="2">
              <div class="rbac">
                <p class="">
                  <a href="/item/<?php echo e($val2->goods_id); ?>">再次购买</a></p>
                  <?php if($val->order_status==1): ?>
                  <p class="inspect">
                  <a href="{:U('Home/Order/comment',array('status'=>0))}">评价</a> </p>
                  <?php endif; ?>
              </div>
            </td>
          </tr>
