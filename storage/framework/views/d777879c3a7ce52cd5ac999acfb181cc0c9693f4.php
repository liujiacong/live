...
<html lang="en">
  ...
  <body>
    <div class="fn-cart-confirm">
        ...
        <!-- end收货信息 -->
        <form name="cart2_form" id="cart2_form" method="post" action="/carto2">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href='/user/address/<?php echo e($val->id); ?>/delete'>
                  ...
                  <div class="order-pro-list">
                    ...
                    <div class="leiliste">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                          <?php $a=0 ?>
                          <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td class="tr-pro">
                              <ul class="pro-area-2">
                                <li>
                                  <a title="<?php echo e($val->goods_name); ?>" target="_blank" href="/item/<?php echo e($val->goods_id); ?>" seed="item-name"><?php echo e($val->goods_name); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($val->spec_key_name); ?></a></li></ul>
                            </td>
                            <td class="tr-price te-al">¥<?php echo e($val->goods_price); ?></td>
                            <td class="tr-price te-al"></td>
                            <td class="tr-quantity te-al"><?php echo e($val->goods_num); ?></td>
                            <td rowspan="1" class="tr-subtotal te-al">
                              <p>
                                <b class='price'><?php echo e($val->goods_num * $val->goods_price); ?></b>
                              </p>
                            </td>
                          </tr>
                            <?php

                            $a=$a+($val->goods_num * $val->goods_price);
                             ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
