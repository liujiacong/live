			...
			<div class="addre">
				<table border="1" class="biao">
				  ...
				  <tr class="er">
				    ...
				    <td><?php echo e($val->province); ?>-<?php echo e($val->city); ?>-<?php echo e($val->district); ?>-<?php echo e($val->address); ?></td>
				    <td><?php echo e($val->zipcode); ?></td>
				    <td class="hh"><a class="c1 h11" href="javascript:;" data="<?php echo e($val->id); ?>">修改</a> &nbsp;  <a class="c2" href="/user/address/<?php echo e($val->id); ?>/delete">删除</a></td>
						<?php if($val->is_default==1): ?>
						<td><div class="moren">默认地址</div></td>
						<?php else: ?>
						<td><div class="smoren" data="<?php echo e($val->id); ?>"><a href="javascript:;" style="color:rgb(226, 103, 124);">设为默认</a></div></td>
						<?php endif; ?>
					</tr>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</table>
