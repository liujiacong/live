    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <tr>
          ...
          <td ><font color="red"><?php echo e($value->user->name); ?></font></td>
          ...
          <td><font color="#00CC99"><?php echo e($value->money); ?></font></td>

          <td><font color="#00CC99"><?php echo e($value->note); ?></font></td>
         ...
         <a class="button border-main" onclick="return zz(<?php echo e($value->id); ?>)"><span class="icon-edit"></span> 转账</a>
          <?php endif; ?>
          </td>
        </tr>
