    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
       @foreach($order as $key=>$val)
        <tr>
          <td style="text-align:left; padding-left:20px;"><a href="{{$val->id}}" target="_blank">{{$val->order_sn}}</a></td>
          <td>{{$val->user->name}}</td>
          ...
          <a class="button border-main"  href="{{$val->id}}" target="_blank"><span class="icon-edit"></span>查看详情</a>
