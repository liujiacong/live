...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <td>{{$value->order}}</td>
      <td><div class="button-group"><a class="button border-main" href="/admin/shop/cate/{{$value->id}}/edi"><span class="icon-edit"></span> 修改</a>
...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/admin/shop/cate/add">
      {{ csrf_field() }}
