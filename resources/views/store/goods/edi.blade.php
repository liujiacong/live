...
<div class="page">
    ...
    <!--表单数据-->
    <form method="post" id="addEditGoodsForm" action="/store/my/goods/{{$goods->id}}/edit">
<!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="{{$goods->goods_title}}" name="goods_name" class="input-txt"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea rows="3" cols="80" name="goods_remark" class="input-txt">{{$goods->goods_title2}}</textarea>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                      <select name="cate_id" id="cat_id" onChange="get_category(this.value,'cat_id_2','0');" class="small form-control">
                        ...
                        @foreach($me->GoodsCate as $key=>$val)
                        <option value="{{$val->id}}" @if($goods->cate_id==$val->id) selected=ture @endif>
                             {{$val->name}}
                        </option>
                        @endforeach
                      </select>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                  <select name="extend_cate_id" id="extend_cat_id" onChange="get_category(this.value,'extend_cat_id_2','0');" class="small form-control">
                    ...
                    <option value="{{$val->id}}" @if($goods->extend_cate==$val->id) selected=ture @endif>
                         {{$val->name}}
                    </option>
                    @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <select name="goods_type" id="spec_type" class="form-control" style="width:250px;">
                                                    ...
                                                    @foreach($me->GoodsType as $key=>$val)
                                                    <option value={{$val->id}} @if($goods->goods_type==$val->id) selected=ture @endif>
                                                         {{$val->name}}
                                                    </option>
                                                    @endforeach
                                                  </select>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="{{$goods->shop_price}}" name="shop_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="{{$goods->market_Price}}" name="market_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="{{$goods->cost_price}}" name="cost_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="{{$goods->order}}" name="order" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                    <span class="err" id="err_market_price" style="color:#F00; display:none;"></span>
                </dd>
            </dl>
            <div class="ncap-form-default tab_div_3">
          ...
          ?>
                <div class="upload_warp_img" @if($picture=='')style="display: none;"@endif >
                  ...
                  <?php foreach ($picture as $key => $value){ ?>
                              ...
                              <div class="upload_warp_img_div" id="div{$key}">
                                  ...
                                  <img src="{{$value}}">
                                  <input type="hidden" name="pic2[]" value="{{$value}}">
                              </div>
                            <?php } ?>
                            <?php } ?>
        ...
        console.log(spec_type)
            $.ajax({
              headers: {
                    ...
                    type:'POST',
                    data:{spec_type:spec_type,goods_id:goods_id},
            ...
            $.ajax({
              headers: {
                 ...
                 type:'POST',
                 data:{type_id:spec_type,goods_id:goods_id},
