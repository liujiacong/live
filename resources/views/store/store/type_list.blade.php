  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <td><div class="button-group">
        <a class="button border-main" href="/store/my/attr_cate/{{$value->id}}"><span class="icon"></span> 属性</a>
        <a class="button border-red" href="/store/my/spec_cate/{{$value->id}}"><span class="icon"></span> 规格</a>
      </div>
    </td>
      <td><div class="button-group">
        <a class="button border-main" href="/store/my/{{$value->id}}/type_edi"><span class="icon-edit"></span> 修改</a>
